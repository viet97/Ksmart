...
export default class URlConfig {
    ...
    static getLoginRouter(username, password, idct) {
        ...
        return URlConfig.BASE_URL_APP + '/AppLogin.aspx?token=' + md5.hex_md5(Date.now()) + '&trangthaigps=1&congty='
            ...
            + 'accuracy=0&osversion=' + DeviceInfo.getSystemVersion() + '&dongmay=' + DeviceInfo.getModel() + '&doimay='
            + '&imei='+DeviceInfo.getBuildNumber()+'&devicename='+DeviceInfo.getManufacturer()+'&isCheDoTietKiemPin=0'
